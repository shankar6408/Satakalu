...
export class AppComponent {
    constructor() {
        ...
        // console.log(
        //     `screen.mainScreen.heightDIPs ${screen.mainScreen.heightDIPs}`
        // ); // The absolute height of the screen in density independent pixels.
        // console.log(
        //     `screen.mainScreen.heightPixels ${screen.mainScreen.heightPixels}`
        ...
        // console.log(
        //     `screen.mainScreen.widthDIPs ${screen.mainScreen.widthDIPs}`
        // ); // The absolute width of the screen in density independent pixels.
        // console.log(
        //     `screen.mainScreen.widthPixels ${screen.mainScreen.widthPixels}`
